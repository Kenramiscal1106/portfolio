...
<div
	class="relative -mx-4 -mt-20 flex min-h-[calc(100vh/2)] flex-col justify-center gap-2 overflow-hidden rounded-none px-6 pt-20 pb-4 sm:mx-0 sm:mt-0 sm:rounded-2xl sm:px-10 sm:pt-4"
	style={`background: url("${imageURL}") no-repeat center;background-size:cover`}
>
	...
	<div class="z-10 flex flex-col gap-2">
		...
		<p class="text-neutrals-100">{description}</p>
		<div>
