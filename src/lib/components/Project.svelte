...
<article
	class="bg-neutrals-100 flex h-full flex-col rounded-xl p-4 transition-all duration-150 {className} shadow-xl"
>
	<div class="from-neutrals-600 to-neutrals-300 overflow-hidden rounded-sm bg-gradient-to-b">
